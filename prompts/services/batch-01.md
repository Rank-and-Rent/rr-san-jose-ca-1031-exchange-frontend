...
2) 45-day-identification-strategy — 45 Day Identification Strategy Layout: timeline-focused
3) three-property-rule-planning — Three Property Rule Planning Layout: compliance-heavy
4) reverse-exchange-coordination — Reverse Exchange Coordination Layout: step-by-step
5) boot-analysis — Boot Analysis Layout: comparison
6) multifamily-property-search — Multifamily Property Search Layout: property-first
7) nnn-lease-property-discovery — NNN Lease Property Discovery Layout: property-first
8) timeline-control-services — Timeline Control Services Layout: timeline-focused
