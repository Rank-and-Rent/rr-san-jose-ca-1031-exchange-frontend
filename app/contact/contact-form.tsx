    ...
    <div id="contact-form" className="border border-white/25 bg-brand-charcoal/50 p-8">
      <form className="space-y-6" onSubmit={handleSubmit}>
        <fieldset disabled={status === "submitting"} className="space-y-6">
          ...
          <button type="submit" className="w-full border border-white bg-white px-8 py-4 text-sm font-semibold uppercase tracking-widest text-navy transition-all duration-300 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed">
