      ...
      <main className="max-w-7xl mx-auto px-6 md:px-10 py-20 md:py-28">
        <div className="space-y-12">
          <div className="space-y-6 text-center">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#3B82F6]">Service Areas</p>
            <h1 className="text-4xl font-semibold text-[#0F172A] md:text-5xl">
              1031 Exchange Service Areas Across Silicon Valley
            </h1>
          ...
          <div className="max-w-2xl mx-auto">
            <SearchInput
              ...
              items={locationItems}
              contactRedirectPrefix="Service Area: "
            />
          </div>
          ...
          <div className="rounded-3xl border border-[#3B82F6] bg-gradient-to-br from-[#EFF6FF] to-white p-8 text-center">
            <h2 className="text-2xl font-semibold text-[#0F172A]">Looking for a different service area?</h2>
