...
function useParams({
  ...
  }), [params.changesInspectorTab, params.comment, params.inspect, params.instruction, params.path, params.pathKey, params.parentRefPath, params.rev, params.since, params.template, params.templateParams, params.view, params.scheduledDraft]), searchParams = React.useMemo(() => pruneObject({
...
function PresentationTool(props) {
  const {
    ...
    state: routerState
  } = router.useRouter(), routerSearchParams = sanity.useUnique(Object.fromEntries(routerState._searchParams || [])), canSharePreviewAccess = react.useSelector(previewUrlRef, (state) => state.context.previewMode?.shareAccess !== !1), [devMode] = React.useState(() => {
